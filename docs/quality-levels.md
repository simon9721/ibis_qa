...
- `3.3.1` `semi_auto` - [Diff Pin] referenced pin models match (3.3 Component Diff Pin Requirements)
...
- `5.3.1` `semi_auto` - I-V tables have correct typ/min/max order (5.3 Model I-V Table Requirements)
...
- `5.3.8` `semi_auto` - [Pulldown] I-V tables pass through zero/zero (5.3 Model I-V Table Requirements)
- `5.3.9` `semi_auto` - [Pullup] I-V tables pass through zero/zero (5.3 Model I-V Table Requirements)
...
- `5.7.1` `semi_auto` - All output-capable models include [ISSO PU] and [ISSO PD] tables (5.7 Model ISSO Table Requirements)
