...
- Generated: 2026-06-09T23:35:15-05:00
- IBIS file: `ibis_bbg484_package_pin.ibs`
- Target level: IQ3
- IBIS version: 5.0
- File revision: 1.0
- IBIS file date: February 09,2021
...
| LEVEL 2 | 5.1.3 - [Temperature Range] is reasonable | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires extraction conditions, technology behavior, and datasheet operating temperature comparison. |  |
| LEVEL 2 | 5.2.5 - [Model Spec] S_Overshoot subparameters complete and match data sheet | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet functional overshoot limits. |  |
| LEVEL 2 | 5.2.7 - [Model Spec] D_Overshoot_* subparameters complete and match data sheet | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet dynamic overshoot limits and documented conversion method. |  |
| LEVEL 2 | 5.3.11 - I-V behavior not double-counted | File/Header | ibis_bbg484_package_pin.ibs | Pending | Double-counting of clamp, driver, and termination behavior needs curve/context review. |  |
| LEVEL 2 | 5.3.12 - On-die termination modeling documented | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires documentation review for on-die termination modeling method. |  |
| LEVEL 3 | 5.2.1 - [Model] Vinl and Vinh reasonable | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires comparing thresholds against datasheet and Vmeas intent. |  |
| LEVEL 3 | 5.2.2 - [Model Spec] Vinl and Vinh reasonable | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet threshold ranges and supply variation interpretation. |  |
| LEVEL 3 | 5.2.3 - [Model Spec] Vinl+/- and Vinh+/- complete and reasonable | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet/hysteresis intent plus comment review for exceptions. |  |
| LEVEL 3 | 5.2.9 - [Receiver Thresholds] Vth present and matches data sheet, if needed | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet timing threshold and receiver-threshold applicability. |  |
| LEVEL 3 | 5.2.10 - [Receiver Thresholds] Vth_min and Vth_max present and match data sheet, if needed | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet Vth tolerance interpretation. |  |
| LEVEL 3 | 5.2.11 - [Receiver Thresholds] Vinh_ac, Vinl_ac present and match data sheet, if needed | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet AC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.12 - [Receiver Thresholds] Vinh_dc, Vinl_dc present and match data sheet, if needed | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet DC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.13 - [Receiver Thresholds] Tslew_ac/Tdiffslew_ac present and match data sheet, if needed | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet slew-limit values and differential/single-ended applicability. |  |
| LEVEL 3 | 5.2.14 - [Receiver Thresholds] Threshold_sensitivity and Ext_ref present and match data sheet, if needed | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires datasheet/reference-supply behavior. |  |
| LEVEL 3 | 5.6.1 - [Model Spec] Vmeas and Vref used if typ/min/max variation | File/Header | ibis_bbg484_package_pin.ibs | Pending | Requires deciding whether Vmeas/Vref variation exists across corners. |  |
