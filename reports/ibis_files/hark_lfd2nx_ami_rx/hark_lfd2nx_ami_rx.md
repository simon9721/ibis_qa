...
- Generated: 2026-06-09T23:35:22-05:00
- IBIS file: `lfd2nx_ami_rx.ibs`
- Target level: IQ3
- IBIS version: 6.0
- File revision: 1.0
...
| Candidate level from checked items | IQ2 |
| Candidate level after review overlay | IQ2 |
| Tool comments | Candidate IQ2; resolve the FAIL/ERROR findings before final IQ assignment. WARN and review-required items also need documented judgement. |
...
| Hard blockers after review | 1 |
| Semi-auto review pending | 1 / 1 |
...
1 item(s) require attention. Each entry links to its full write-up in Quality Check Results and shows the most relevant visual where the issue is reflected in a plot. Items without an associated plot are rule/range checks best understood from the explanation text.


### FAIL: 3.2.2 - lfd2nx_Serdes_Rx
...
Checking C:\Users\simom\Desktop\Projects\IBIS Files\Hark Labs\FPGA-MD-02115-1-0-Certus-NX-IBIS-AMI-File\FPGA-MD-02115-1-0-Certus-NX-IBIS-AMI-File\model_files\lfd2nx_ami_rx.ibs for IBIS 6.0 Compatibility...


... Reading C:\Users\simom\Desktop\Projects\IBIS Files\Hark Labs\FPGA-MD-02115-1-0-Certus-NX-IBIS-AMI-File\FPGA-MD-02115-1-0-Certus-NX-IBIS-AMI-File\model_files\lfd2nx_rx.ami

... Checking lfd2nx_rx.ami for Implicit AMI Version 5.0 Compatibility...

... Done Checking lfd2nx_rx.ami
... Done Reading lfd2nx_rx.ami

... Status of [Algorithmic Model] Executables for Windows 64:
lfd2nx_Rx2_rh64.dll:		Linux 64:		Not Checked
lfd2nx_Rx2_x64.dll:		Windows 64:		Checked
lfd2nx_Rx2_x86.dll:		Windows 32:		Not Checked
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_Serdes_Rx |  | All [Package] R/L/C have typ, min, and max values |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_Serdes_Rx |  | Package values within limits and min≤typ≤max |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_Serdes_Rx |  | [Pin] has 4 complete entry/entries with resolvable model references |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_Serdes_Rx |  | All [Diff Pin] model names match or have explanatory comments |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| File/Header | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_ami_rx.ibs |  | No [Model Selector] sections parsed from raw file |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | 3 model parameter set(s) have typ/min/max order evidence: C_comp; Voltage Range |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | C_comp evidence is positive and within review threshold: C_comp |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | Voltage/reference evidence parsed, defaults resolved, and basic consistency looks reasonable: Voltage Range: typ=0.8V, min=0.8V, max=0.8V (explicit); Pullup Reference: typ=0.8V, min=0.8V, max=0.8V (default from Voltage Range) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | No [Model Spec] S_Overshoot data parsed |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | No [Model Spec] D_Overshoot data parsed |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | [GND Clamp] rows are voltage/typ/min/max |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | Model_type=Input has no required [Pullup] table - NA |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | Model_type=Input has no required [Pulldown] table - NA |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | [GND Clamp] voltage sweep OK (-1V to 1V) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | I-V stair-step roughness evidence is within threshold |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | [Pulldown] + [GND Clamp] combined curve monotonicity OK (nondecreasing, 3 sample point(s)) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_in |  | Clamp leakage evidence is within threshold at 0V |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | WARN | 0 | 1 | 0 | 0 | 0 | 1 | lfd2nx_in | [lfd2nx_in I-V curves](#curve-lfd2nx-in-iv) | I-V point distribution evidence needs review: [GND Clamp]: 3 point(s) < 20 |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | No V-T waveform tables parsed |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | No [Ramp] data parsed |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | Ramp or V-T waveform data absent |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | FAIL | 0 | 0 | 1 | 0 | 0 | 0 | lfd2nx_Serdes_Rx |  | 2 pin RLC issue(s): Pin 2: missing L/C values; Pin 3: missing L/C values |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | lfd2nx_Serdes_Rx |  | All [Diff Pin] Vdiff/Tdelay values consistent with model type |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 1 | 0 | 0 | lfd2nx_in |  | Model_type=Input does not require this Vref consistency evidence |
...
##### I-V Clamp Curves
<a id="curve-lfd2nx-in-iv"></a>

Related WARN/FAIL QA items: [5.3.14](#check-5-3-14)

![I-V Clamp Curves for lfd2nx_in](hark_lfd2nx_ami_rx_assets/iv_lfd2nx_in.svg)

##### I-V clamp detail
<a id="curve-lfd2nx-in-iv-clamp"></a>

![I-V clamp detail for lfd2nx_in](hark_lfd2nx_ami_rx_assets/iv_clamp_lfd2nx_in.svg)

##### I-V clamp sweep range
<a id="curve-lfd2nx-in-iv-clamp-sweep"></a>

![I-V clamp sweep range for lfd2nx_in](hark_lfd2nx_ami_rx_assets/iv_clamp_sweep_lfd2nx_in.svg)
...
|---|---|---|---|---|---|---|
| LEVEL 2 | 4.2 - Default [Model Selector] entries are consistent | Component | lfd2nx_Serdes_Rx | Pending | Default model selector consistency depends on product configuration and likely use cases. |  |
| LEVEL 2 | 5.1.3 - [Temperature Range] is reasonable | Model | lfd2nx_in | Pending | Requires extraction conditions, technology behavior, and datasheet operating temperature comparison. |  |
| LEVEL 2 | 5.2.5 - [Model Spec] S_Overshoot subparameters complete and match data sheet | Model | lfd2nx_in | Pending | Requires datasheet functional overshoot limits. |  |
| LEVEL 2 | 5.2.7 - [Model Spec] D_Overshoot_* subparameters complete and match data sheet | Model | lfd2nx_in | Pending | Requires datasheet dynamic overshoot limits and documented conversion method. |  |
| LEVEL 2 | 5.3.11 - I-V behavior not double-counted | Model | lfd2nx_in | Pending | Double-counting of clamp, driver, and termination behavior needs curve/context review. |  |
| LEVEL 2 | 5.3.12 - On-die termination modeling documented | Model | lfd2nx_in | Pending | Requires documentation review for on-die termination modeling method. |  |
| LEVEL 3 | 5.2.1 - [Model] Vinl and Vinh reasonable | Model | lfd2nx_in | Pending | Requires comparing thresholds against datasheet and Vmeas intent. |  |
| LEVEL 3 | 5.2.2 - [Model Spec] Vinl and Vinh reasonable | Model | lfd2nx_in | Pending | Requires datasheet threshold ranges and supply variation interpretation. |  |
| LEVEL 3 | 5.2.3 - [Model Spec] Vinl+/- and Vinh+/- complete and reasonable | Model | lfd2nx_in | Pending | Requires datasheet/hysteresis intent plus comment review for exceptions. |  |
| LEVEL 3 | 5.2.9 - [Receiver Thresholds] Vth present and matches data sheet, if needed | Model | lfd2nx_in | Pending | Requires datasheet timing threshold and receiver-threshold applicability. |  |
| LEVEL 3 | 5.2.10 - [Receiver Thresholds] Vth_min and Vth_max present and match data sheet, if needed | Model | lfd2nx_in | Pending | Requires datasheet Vth tolerance interpretation. |  |
| LEVEL 3 | 5.2.11 - [Receiver Thresholds] Vinh_ac, Vinl_ac present and match data sheet, if needed | Model | lfd2nx_in | Pending | Requires datasheet AC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.12 - [Receiver Thresholds] Vinh_dc, Vinl_dc present and match data sheet, if needed | Model | lfd2nx_in | Pending | Requires datasheet DC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.13 - [Receiver Thresholds] Tslew_ac/Tdiffslew_ac present and match data sheet, if needed | Model | lfd2nx_in | Pending | Requires datasheet slew-limit values and differential/single-ended applicability. |  |
| LEVEL 3 | 5.2.14 - [Receiver Thresholds] Threshold_sensitivity and Ext_ref present and match data sheet, if needed | Model | lfd2nx_in | Pending | Requires datasheet/reference-supply behavior. |  |
| LEVEL 3 | 5.6.1 - [Model Spec] Vmeas and Vref used if typ/min/max variation | Model | lfd2nx_in | Pending | Requires deciding whether Vmeas/Vref variation exists across corners. |  |
