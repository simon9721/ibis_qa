...
- Generated: 2026-06-09T23:35:20-05:00
- IBIS file: `abi_gen3.ibs`
- Target level: IQ3
- IBIS version: 5.0
- File revision: 20230801
- IBIS file date: Aug 01, 2023
...
### FAIL: 3.2.2 - ABI_Serdes

- 6 pin RLC issue(s)
- [Full check details](#check-3-2-2)
- Pin 2: missing L/C values
- Pin 3: missing L/C values
- Pin 4: missing L/C values
- Pin 5: missing L/C values
- Pin 6: missing L/C values
- Pin 7: missing L/C values
...
![abi_out I-V curves](hark_abi_gen3_assets/iv_abi_out.svg)
[Jump to I-V curves for abi_out](#curve-abi-out-iv)
...
- Rise dV/typ: ramp=1V, expected≈0.3V (233.3% error, limit 10.0%)
- Rise dV/min: ramp=1V, expected≈0.3243V (208.3% error, limit 10.0%)
- Rise dV/max: ramp=1V, expected≈0.2791V (258.3% error, limit 10.0%)
- Fall dV/typ: ramp=1V, expected≈0.3V (233.3% error, limit 10.0%)
- Fall dV/min: ramp=1V, expected≈0.3243V (208.3% error, limit 10.0%)
- Fall dV/max: ramp=1V, expected≈0.2791V (258.3% error, limit 10.0%)
- Rise dV/typ: ramp=1V, expected≈0.3V from Vhigh=0.5V, Vlow=0V, error=233.3% (push-pull fixture=0V)
- Rise dV/min: ramp=1V, expected≈0.3243V from Vhigh=0.5405V, Vlow=0V, error=208.3% (push-pull fixture=0V)
- Rise dV/max: ramp=1V, expected≈0.2791V from Vhigh=0.4651V, Vlow=0V, error=258.3% (push-pull fixture=0V)
- Fall dV/typ: ramp=1V, expected≈0.3V from Vhigh=1V, Vlow=0.5V, error=233.3% (push-pull fixture=1V)
...
- Models with estimates: 1 / 3
- Estimated table/corner points: 6

| Model | Type | Pulldown Zout typ/min/max | Pullup Zout typ/min/max | Load-line plot | Notes |
|---|---|---:|---:|---|---|
| abi_in | Input | NA / NA / NA | NA / NA / NA |  | No usable Pullup/Pulldown driver table. |
| abi_out | Output | 50 ohm / 42.5 ohm / 57.5 ohm | 50 ohm / 42.5 ohm / 57.5 ohm | [View plot](#curve-abi-out-zout) | Estimated from available corners. |
| refclk | Input | NA / NA / NA | NA / NA / NA |  | No usable Pullup/Pulldown driver table. |
...
Checking C:\Users\simom\Desktop\Projects\IBIS Files\Hark Labs\FPGA-MD-02047-1-1-CertusPro-NX-IBIS-AMI Model_file\abi_gen3.ibs for IBIS 5.1 Compatibility...


... Reading C:\Users\simom\Desktop\Projects\IBIS Files\Hark Labs\FPGA-MD-02047-1-1-CertusPro-NX-IBIS-AMI Model_file\abi_g3_rx.ami

... Checking abi_g3_rx.ami for Implicit AMI Version 5.0 Compatibility...

... Done Checking abi_g3_rx.ami
... Done Reading abi_g3_rx.ami


... Reading C:\Users\simom\Desktop\Projects\IBIS Files\Hark Labs\FPGA-MD-02047-1-1-CertusPro-NX-IBIS-AMI Model_file\abi_g3_tx.ami

... Checking abi_g3_tx.ami for Implicit AMI Version 5.0 Compatibility...

... Done Checking abi_g3_tx.ami
... Done Reading abi_g3_tx.ami

... Status of [Algorithmic Model] Executables for Windows 64:
ABICDR_Tx_rh64.dll:		Linux 64:		Not Checked
ABICDR_Tx_x64.dll:		Windows 64:		Checked
ABICDR_Tx_x86.dll:		Windows 32:		Not Checked
ABICDR_Rx2_rh64.dll:		Linux 64:		Not Checked
```
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | ABI_Serdes |  | All [Package] R/L/C have typ, min, and max values |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | ABI_Serdes |  | Package values within limits and min≤typ≤max |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | ABI_Serdes |  | [Pin] has 8 complete entry/entries with resolvable model references |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | ABI_Serdes |  | All [Diff Pin] model names match or have explanatory comments |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| File/Header | NA | 0 | 0 | 0 | 1 | 0 | 0 | abi_gen3.ibs |  | No [Model Selector] sections parsed from raw file |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 3 | 0 | 0 | 0 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 3x 3 model parameter set(s) have typ/min/max order evidence: C_comp; Voltage Range |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 3 | 0 | 0 | 0 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 3x C_comp evidence is positive and within review threshold: C_comp |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 3 | 0 | 0 | 0 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 2x Voltage/reference evidence parsed, defaults resolved, and basic consistency looks reasonable: Voltage Range: typ=1V, min=1V, max=1V (explicit); Pullup Reference: typ=1V, min=1V, max=1V (default from Voltage Range)<br>Voltage/reference evidence parsed, defaults resolved, and basic consistency looks reasonable: Voltage Range: typ=1.8V, min=1.71V, max=1.89V (explicit); Pullup Reference: typ=1.8V, min=1.71V, max=1.89V (default from Voltage Range) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 3 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 3x No [Model Spec] S_Overshoot data parsed |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 3 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 3x No [Model Spec] D_Overshoot data parsed |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 5 | 0 | 0 | 0 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 2x [GND Clamp] rows are voltage/typ/min/max<br>[Pulldown] rows are voltage/typ/min/max with expected active-region corner ordering<br>[Pullup] rows are voltage/typ/min/max with expected active-region corner ordering<br>1 more evidence message(s) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | FAIL | 0 | 0 | 1 | 2 | 0 | 0 | abi_in<br>abi_out<br>refclk | [abi_out I-V curves](#curve-abi-out-iv) | [Pullup] voltage sweep insufficient: High end: table ends at 1V, need ≥ 2V |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | FAIL | 0 | 0 | 1 | 2 | 0 | 0 | abi_in<br>abi_out<br>refclk | [abi_out I-V curves](#curve-abi-out-iv) | [Pulldown] voltage sweep insufficient: High end: table ends at 1V, need ≥ 2V |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | refclk |  | [POWER Clamp] voltage sweep OK (-1.8V to 1.8V) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 2 | 0 | 0 | 0 | 0 | 0 | abi_in<br>refclk |  | [GND Clamp] voltage sweep OK (-1V to 1V)<br>[GND Clamp] voltage sweep OK (-1.8V to 1.8V) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | WARN | 1 | 2 | 0 | 0 | 0 | 2 | abi_in<br>abi_out<br>refclk | [abi_in I-V curves](#curve-abi-in-iv)<br>[abi_out I-V curves](#curve-abi-out-iv) | I-V stair-step evidence needs review: [GND Clamp]: roughness=0.5 > 0.1<br>I-V stair-step evidence needs review: [Pulldown]: roughness=0.5 > 0.1; [Pullup]: roughness=0.5 > 0.1 |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 5 | 0 | 0 | 0 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 2x [Pulldown] + [GND Clamp] combined curve monotonicity OK (nondecreasing, 3 sample point(s))<br>[Pullup] + [POWER Clamp] combined curve monotonicity OK (nonincreasing, 3 sample point(s))<br>[Pulldown] + [GND Clamp] combined curve monotonicity OK (nondecreasing, 98 sample point(s))<br>1 more evidence message(s) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 2 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 2x Model_type=Input has no required [Pulldown] table - NA<br>[Pulldown] passes through near 0 at 0V (within +/-1uA) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 2 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 2x Model_type=Input has no required [Pullup] table - NA<br>[Pullup] passes through near 0 at 0V (within +/-1uA) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | WARN | 2 | 1 | 0 | 0 | 0 | 1 | abi_in<br>abi_out<br>refclk | [refclk I-V clamp detail](#curve-refclk-iv-clamp) | Clamp leakage evidence needs review: [GND Clamp]: I(0V)=-8.57 uA; [POWER Clamp]: I(0V)=2.04 uA |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | WARN | 1 | 2 | 0 | 0 | 0 | 2 | abi_in<br>abi_out<br>refclk | [abi_in I-V curves](#curve-abi-in-iv)<br>[abi_out I-V curves](#curve-abi-out-iv) | I-V point distribution evidence needs review: [GND Clamp]: 3 point(s) < 20<br>I-V point distribution evidence needs review: [Pulldown]: 3 point(s) < 20; [Pullup]: 3 point(s) < 20 |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 3 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 3x No V-T waveform tables parsed |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 0 | 0 | 0 | abi_out |  | R_load = 50.0Ω documented |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | PASS | 1 | 0 | 0 | 2 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 2x No [Ramp] data parsed<br>Ramp typ/min/max slew order evidence is ordered: dV/dt_r; dV/dt_f |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | FAIL | 0 | 0 | 1 | 0 | 0 | 0 | abi_out |  | [Ramp] dV inconsistent with I-V load-line (6 corner(s)): Rise dV/typ: ramp=1V, expected≈0.3V (233.3% error, limit 10.0%); Rise dV/min: ramp=1V, expected≈0.3243V (208.3% error, limit 10.0%) |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 3 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 3x Ramp or V-T waveform data absent |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | FAIL | 0 | 0 | 1 | 0 | 0 | 0 | ABI_Serdes |  | 6 pin RLC issue(s): Pin 2: missing L/C values; Pin 3: missing L/C values |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Component | PASS | 1 | 0 | 0 | 0 | 0 | 0 | ABI_Serdes |  | All [Diff Pin] Vdiff/Tdelay values consistent with model type |
...
| Type | Outcome | Pass | Warn | Fail | NA | Error | Review | Subjects | Visual Curves | Explanation / Details |
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Model | NA | 0 | 0 | 0 | 3 | 0 | 0 | abi_in<br>abi_out<br>refclk |  | 2x Model_type=Input does not require this Vref consistency evidence<br>Model_type=Output does not require this Vref consistency evidence |
...
##### I-V Clamp Curves
<a id="curve-abi-in-iv"></a>

Related WARN/FAIL QA items: [5.3.6](#check-5-3-6), [5.3.14](#check-5-3-14)

![I-V Clamp Curves for abi_in](hark_abi_gen3_assets/iv_abi_in.svg)

##### I-V clamp detail
<a id="curve-abi-in-iv-clamp"></a>

![I-V clamp detail for abi_in](hark_abi_gen3_assets/iv_clamp_abi_in.svg)

##### I-V clamp sweep range
<a id="curve-abi-in-iv-clamp-sweep"></a>

![I-V clamp sweep range for abi_in](hark_abi_gen3_assets/iv_clamp_sweep_abi_in.svg)
...
<a id="curve-abi-out-iv"></a>

Related WARN/FAIL QA items: [5.3.2](#check-5-3-2), [5.3.3](#check-5-3-3), [5.3.6](#check-5-3-6), [5.3.14](#check-5-3-14)

![I-V Pullup/Pulldown Curves for abi_out](hark_abi_gen3_assets/iv_abi_out.svg)

##### I-V pullup/pulldown 0 V detail
<a id="curve-abi-out-iv-zero"></a>

![I-V pullup/pulldown 0 V detail for abi_out](hark_abi_gen3_assets/iv_zero_abi_out.svg)

##### Zout load-line curves
<a id="curve-abi-out-zout"></a>

![Zout load-line curves for abi_out](hark_abi_gen3_assets/zout_abi_out.svg)
...
##### I-V Clamp Curves
<a id="curve-refclk-iv"></a>

![I-V Clamp Curves for refclk](hark_abi_gen3_assets/iv_refclk.svg)

##### I-V clamp detail
<a id="curve-refclk-iv-clamp"></a>

Related WARN/FAIL QA items: [5.3.10](#check-5-3-10)

![I-V clamp detail for refclk](hark_abi_gen3_assets/iv_clamp_refclk.svg)

##### I-V clamp sweep range
<a id="curve-refclk-iv-clamp-sweep"></a>

![I-V clamp sweep range for refclk](hark_abi_gen3_assets/iv_clamp_sweep_refclk.svg)
...
|---|---|---|---|---|---|---|
| LEVEL 2 | 4.2 - Default [Model Selector] entries are consistent | Component | ABI_Serdes | Pending | Default model selector consistency depends on product configuration and likely use cases. |  |
| LEVEL 2 | 5.1.3 - [Temperature Range] is reasonable | Model | abi_in | Pending | Requires extraction conditions, technology behavior, and datasheet operating temperature comparison. |  |
| LEVEL 2 | 5.1.3 - [Temperature Range] is reasonable | Model | abi_out | Pending | Requires extraction conditions, technology behavior, and datasheet operating temperature comparison. |  |
| LEVEL 2 | 5.1.3 - [Temperature Range] is reasonable | Model | refclk | Pending | Requires extraction conditions, technology behavior, and datasheet operating temperature comparison. |  |
| LEVEL 2 | 5.2.5 - [Model Spec] S_Overshoot subparameters complete and match data sheet | Model | abi_in | Pending | Requires datasheet functional overshoot limits. |  |
| LEVEL 2 | 5.2.5 - [Model Spec] S_Overshoot subparameters complete and match data sheet | Model | abi_out | Pending | Requires datasheet functional overshoot limits. |  |
| LEVEL 2 | 5.2.5 - [Model Spec] S_Overshoot subparameters complete and match data sheet | Model | refclk | Pending | Requires datasheet functional overshoot limits. |  |
| LEVEL 2 | 5.2.7 - [Model Spec] D_Overshoot_* subparameters complete and match data sheet | Model | abi_in | Pending | Requires datasheet dynamic overshoot limits and documented conversion method. |  |
| LEVEL 2 | 5.2.7 - [Model Spec] D_Overshoot_* subparameters complete and match data sheet | Model | abi_out | Pending | Requires datasheet dynamic overshoot limits and documented conversion method. |  |
| LEVEL 2 | 5.2.7 - [Model Spec] D_Overshoot_* subparameters complete and match data sheet | Model | refclk | Pending | Requires datasheet dynamic overshoot limits and documented conversion method. |  |
| LEVEL 2 | 5.3.11 - I-V behavior not double-counted | Model | abi_in | Pending | Double-counting of clamp, driver, and termination behavior needs curve/context review. |  |
| LEVEL 2 | 5.3.11 - I-V behavior not double-counted | Model | abi_out | Pending | Double-counting of clamp, driver, and termination behavior needs curve/context review. |  |
| LEVEL 2 | 5.3.11 - I-V behavior not double-counted | Model | refclk | Pending | Double-counting of clamp, driver, and termination behavior needs curve/context review. |  |
| LEVEL 2 | 5.3.12 - On-die termination modeling documented | Model | abi_in | Pending | Requires documentation review for on-die termination modeling method. |  |
| LEVEL 2 | 5.3.12 - On-die termination modeling documented | Model | abi_out | Pending | Requires documentation review for on-die termination modeling method. |  |
| LEVEL 2 | 5.3.12 - On-die termination modeling documented | Model | refclk | Pending | Requires documentation review for on-die termination modeling method. |  |
| LEVEL 3 | 5.2.1 - [Model] Vinl and Vinh reasonable | Model | abi_in | Pending | Requires comparing thresholds against datasheet and Vmeas intent. |  |
| LEVEL 3 | 5.2.1 - [Model] Vinl and Vinh reasonable | Model | abi_out | Pending | Requires comparing thresholds against datasheet and Vmeas intent. |  |
| LEVEL 3 | 5.2.1 - [Model] Vinl and Vinh reasonable | Model | refclk | Pending | Requires comparing thresholds against datasheet and Vmeas intent. |  |
| LEVEL 3 | 5.2.2 - [Model Spec] Vinl and Vinh reasonable | Model | abi_in | Pending | Requires datasheet threshold ranges and supply variation interpretation. |  |
| LEVEL 3 | 5.2.2 - [Model Spec] Vinl and Vinh reasonable | Model | abi_out | Pending | Requires datasheet threshold ranges and supply variation interpretation. |  |
| LEVEL 3 | 5.2.2 - [Model Spec] Vinl and Vinh reasonable | Model | refclk | Pending | Requires datasheet threshold ranges and supply variation interpretation. |  |
| LEVEL 3 | 5.2.3 - [Model Spec] Vinl+/- and Vinh+/- complete and reasonable | Model | abi_in | Pending | Requires datasheet/hysteresis intent plus comment review for exceptions. |  |
| LEVEL 3 | 5.2.3 - [Model Spec] Vinl+/- and Vinh+/- complete and reasonable | Model | abi_out | Pending | Requires datasheet/hysteresis intent plus comment review for exceptions. |  |
| LEVEL 3 | 5.2.3 - [Model Spec] Vinl+/- and Vinh+/- complete and reasonable | Model | refclk | Pending | Requires datasheet/hysteresis intent plus comment review for exceptions. |  |
| LEVEL 3 | 5.2.9 - [Receiver Thresholds] Vth present and matches data sheet, if needed | Model | abi_in | Pending | Requires datasheet timing threshold and receiver-threshold applicability. |  |
| LEVEL 3 | 5.2.9 - [Receiver Thresholds] Vth present and matches data sheet, if needed | Model | abi_out | Pending | Requires datasheet timing threshold and receiver-threshold applicability. |  |
| LEVEL 3 | 5.2.9 - [Receiver Thresholds] Vth present and matches data sheet, if needed | Model | refclk | Pending | Requires datasheet timing threshold and receiver-threshold applicability. |  |
| LEVEL 3 | 5.2.10 - [Receiver Thresholds] Vth_min and Vth_max present and match data sheet, if needed | Model | abi_in | Pending | Requires datasheet Vth tolerance interpretation. |  |
| LEVEL 3 | 5.2.10 - [Receiver Thresholds] Vth_min and Vth_max present and match data sheet, if needed | Model | abi_out | Pending | Requires datasheet Vth tolerance interpretation. |  |
| LEVEL 3 | 5.2.10 - [Receiver Thresholds] Vth_min and Vth_max present and match data sheet, if needed | Model | refclk | Pending | Requires datasheet Vth tolerance interpretation. |  |
| LEVEL 3 | 5.2.11 - [Receiver Thresholds] Vinh_ac, Vinl_ac present and match data sheet, if needed | Model | abi_in | Pending | Requires datasheet AC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.11 - [Receiver Thresholds] Vinh_ac, Vinl_ac present and match data sheet, if needed | Model | abi_out | Pending | Requires datasheet AC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.11 - [Receiver Thresholds] Vinh_ac, Vinl_ac present and match data sheet, if needed | Model | refclk | Pending | Requires datasheet AC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.12 - [Receiver Thresholds] Vinh_dc, Vinl_dc present and match data sheet, if needed | Model | abi_in | Pending | Requires datasheet DC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.12 - [Receiver Thresholds] Vinh_dc, Vinl_dc present and match data sheet, if needed | Model | abi_out | Pending | Requires datasheet DC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.12 - [Receiver Thresholds] Vinh_dc, Vinl_dc present and match data sheet, if needed | Model | refclk | Pending | Requires datasheet DC threshold values and offset conversion review. |  |
| LEVEL 3 | 5.2.13 - [Receiver Thresholds] Tslew_ac/Tdiffslew_ac present and match data sheet, if needed | Model | abi_in | Pending | Requires datasheet slew-limit values and differential/single-ended applicability. |  |
| LEVEL 3 | 5.2.13 - [Receiver Thresholds] Tslew_ac/Tdiffslew_ac present and match data sheet, if needed | Model | abi_out | Pending | Requires datasheet slew-limit values and differential/single-ended applicability. |  |
| LEVEL 3 | 5.2.13 - [Receiver Thresholds] Tslew_ac/Tdiffslew_ac present and match data sheet, if needed | Model | refclk | Pending | Requires datasheet slew-limit values and differential/single-ended applicability. |  |
| LEVEL 3 | 5.2.14 - [Receiver Thresholds] Threshold_sensitivity and Ext_ref present and match data sheet, if needed | Model | abi_in | Pending | Requires datasheet/reference-supply behavior. |  |
| LEVEL 3 | 5.2.14 - [Receiver Thresholds] Threshold_sensitivity and Ext_ref present and match data sheet, if needed | Model | abi_out | Pending | Requires datasheet/reference-supply behavior. |  |
| LEVEL 3 | 5.2.14 - [Receiver Thresholds] Threshold_sensitivity and Ext_ref present and match data sheet, if needed | Model | refclk | Pending | Requires datasheet/reference-supply behavior. |  |
| LEVEL 3 | 5.6.1 - [Model Spec] Vmeas and Vref used if typ/min/max variation | Model | abi_in | Pending | Requires deciding whether Vmeas/Vref variation exists across corners. |  |
| LEVEL 3 | 5.6.1 - [Model Spec] Vmeas and Vref used if typ/min/max variation | Model | abi_out | Pending | Requires deciding whether Vmeas/Vref variation exists across corners. |  |
| LEVEL 3 | 5.6.1 - [Model Spec] Vmeas and Vref used if typ/min/max variation | Model | refclk | Pending | Requires deciding whether Vmeas/Vref variation exists across corners. |  |
